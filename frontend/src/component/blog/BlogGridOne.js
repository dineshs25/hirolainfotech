                ...
                <div className="blog-grid" key={data.id}>
                    ...
                    <div className="author">
                        <div className="author-thumb">
                            <img src={`${process.env.PUBLIC_URL}/${data.author_avatar}`} alt="Blog Author" className='aathr' />
                        </div>
                        <div className="info">
                    ...
                    <div className="post-thumbnail">
                        {
                            ...
                            : <Link to={process.env.PUBLIC_URL + `/blog/${slugify(data.title)}`}><img src={`${process.env.PUBLIC_URL}/${data.large_thumb}`} alt="Blog" /></Link>
                        }
