export const DelhiData =  {
    ...
    "dataOne":{
        ...
        "dataOneList":[
            "<h5 class='title mb--30'>Communication</h5>",
            ...
            "<h5 class='title mb--30'>Transparency</h5>",
            ...
            "<h5 class='title mb--30'>Custom SEO Services</h5>",
            ...
            "<h5 class='title mb--30'>Project Management</h5>",
            ...
            "<h5 class='title mb--30'>Committed SEO Manager</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Access to The Pros</h5>",
            ...
            "<h5 class='title mb--30'>No Contracts</h5>",
            ...
            "<h5 class='title mb--30'>Detailed Reporting</h5>",
            ...
            "<h5 class='title mb--30'>Maintain control over the ROI</h5>",
            ...
            "<h5 class='title mb--30'>Total Visibility</h5>",
    ...
    "dataTwo":{
        ...
        "dataOneList":[
            "<h5 class='title mb--30'>Website Seo Audit</h5>",
            ...
            "<h5 class='title mb--30'>Product Pages</h5>",
            ...
            "<h5 class='title mb--30'>RESPONSIVE ON ALL DEVICES</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Keyword Research</h5>",
            ...
            "<h5 class='title mb--30'>Service Pages</h5>",
            ...
            "<h5 class='title mb--30'>Longform ContenT</h5>",
            ...
            "<h5 class='title mb--30'>Page Speed</h5>",
    ...
    "dataThree":{
        ...
        "dataOneList":[
            "<h5 class='title mb--30'>Client’s First – Approach </h5>",
            ...
            "<h5 class='title mb--30'>ROI-Dedicated</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Tech-Enabled</h5>",
            ...
            "<h5 class='title mb--30'>Complete Transparency</h5>",
    ...
    "dataFour":{
        ...
        "dataOneList":[
            "<h5 class='title mb--30'>Website Content</h5>",
            ...
            "<h5 class='title mb--30'>Creating Sitemaps</h5>",
            ...
            "<h5 class='title mb--30'>Engaging website linking</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Image Optimisation</h5>",
            ...
            "<h5 class='title mb--30'>Link Building</h5>",
            ...
            "<h5 class='title mb--30'>Title & Description</h5>",
...
export const ChennaiData =    {
    ...
    "dataTwo":{
        ...
        "dataOneList":[
            "<h5 class='title mb--30'>Better Search Engine Rankings</h5>",
            ...
            "<h5 class='title mb--30'>Improved Conversion Rates</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Improved Brand Awareness</h5>",
            ...
            "<h5 class='title mb--30'>Increased Customer Engagement</h5>",
    ...
    "dataThree":{
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Creation of Sitemaps</h5>",
    ...
    "dataFour":{
        "title":"Major SEO Strategies that we Work On",
        "dataOneList":[
            "<h5 class='title mb--30'>Project Analysis</h5>",
            ...
            "<h5 class='title mb--30'>On-Page Optimisation</h5>",
            ...
            "<h5 class='title mb--30'>Reporting</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Off-Page Optimisation</h5>",
            ...
            "<h5 class='title mb--30'>Competitive Research</h5>",
            ...
            "<h5 class='title mb--30'>Re-Assessment</h5>",
...
export const HyderbadData =  {
    ...
    "dataOne":{
        ...
        "dataOneList":[
            ...
            "<h5 class='title mb--30'>Committed SEO ManagerCommitted SEO Manager</h5>",
            "<p>Always have SEO experts at Hirola InfoTech who handle your project on their own. The committed SEO project manager will give priority to your input, and understands the goals of your business and your strategic goals.</p>"
        ],
        "dataTwoList":[
            "<h5 class='title mb--30'>Access to The Pros</h5>",
    ...
    "dataThree":{
        ...
        "dataOneList":[
            "<h5 class='title mb--30'>Higher Position In Search Results Pages</h5>",
            ...
            "<h5 class='title mb--30'>Ample Site Traffic</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Expansion of Conversions</h5>",
            ...
            "<h5 class='title mb--30'>Unstoppable Business Growth</h5>",
...
export const KolkataData =   {
    ...
    "dataTwo":{
        ...
        "dataOneList":[
            "<h5 class='title mb--30'>Experience Team</h5>",
            ...
            "<h5 class='title mb--30'>24/7 Client Support</h5>",
            ...
            "<h5 class='title mb--30'>Relationships & Results</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Consistently Better Results</h5>",
            ...
            "<h5 class='title mb--30'>Transparent Reporting</h5>",
            ...
            "<h5 class='title mb--30'>Strategize & Planning</h5>",
    ...
    "dataThree":{
        ...
        "dataOneList":[
            "<h5 class='title mb--30'>Flawless Take-Off and landing</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Top-Rated Paid Tools</h5>",
    ...
    "dataFour":{
        ...
        "dataOneList":[
            "<h5 class='title mb--30'>Team of SEO Experts in Kolkata</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>The Most Effective SEO Services in Kolkata</h5>",
...
export const MumbaiData =  {
    ...
    "dataOne":{
        ...
        "dataOneList":[
            "<h5 class='title mb--30'>Full Dedication</h5>",
            ...
            "<h5 class='title mb--30'>Noticeable Outcomes</h5>",
            ...
            "<h5 class='title mb--30'>Problem-solving Approach</h5>",
            ...
            "<h5 class='title mb--30'>Comprehensive Range</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Tailored Packages</h5>",
            ...
            "<h5 class='title mb--30'>Skilled Professionals</h5>",
            ...
            "<h5 class='title mb--30'>Access To Top Seo ToolS</h5>",
            ...
            "<h5 class='title mb--30'>Multiple Inbound Leads</h5>",
...
export const PuneData =  {
    ...
    "dataFour":{
        "title":"How Can SEO Company in Pune Benefits your Business!",
        "dataOneList":[
            "<h5 class='title mb--30'>Weekly Meetings</h5>",
        ...
        "dataTwoList":[
            "<h5 class='title mb--30'>Tailored and Transparent Reporting</h5>",
