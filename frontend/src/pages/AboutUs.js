...
<ul>
          ...
          {/* about us section */}
            ...
            <ul className="list-unstyled shape-group-10">
                ...
                <div className="section brand-wrap-area bg-color-dark bg-light heading-left">
                    <div className="container">
                    <h2 className='text-center' >Our Clients</h2>
                        ...
                        <div className="about-client-image col-6" key={index}>
                            <div className="brand-grid">
                                <img src={process.env.PUBLIC_URL + data.imageUrl} alt="Brand" />
                            </div>
                        </div>
                    ))}
                        </div>
  ...
  <VerticalTimelineElement
    ...
    iconStyle={{ background: 'linear-gradient(to right, #6366f1, #8B5CF6, #D946EF)', color: '#fff' }}
