...
const BlogDetails = () => {
    ...
    const getBlogData = allBlogData.filter(data => slugify(data.title) === blogSlug);
    const detailsBlog = getBlogData[0];
                                    ...
                                    <div className="single-blog-content blog-grid">
                                        ...
                                        <div className="author">
                                            <div className="author-thumb">
                                                <img src={`${process.env.PUBLIC_URL}/${detailsBlog.author_avatar}`} alt="Blog Author" className='aathr' />
                                            </div>
                                            <div className="info">
