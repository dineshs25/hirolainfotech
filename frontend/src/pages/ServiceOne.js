            ...
            <div className="service-scroll-navigation-area">
                ...
                <nav id="onepagenav" className="service-scroll-nav navbar onepagefixed sticky-top">
                    <div className="container ">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#section7">Testing</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#section8">Cloud Computing</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#section9">Consultancy</a>
                        </li>
                        </ul>
                    </div>
                </nav>
                ...
                <div className="section section-padding " id="section6">
                    <div className="container">
                        <SectionTitle 
