                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-10">
                                ...
                                <div className="section-title">
                                    <h5 className="title">This Privacy policy was published on May 1st, 2023.</h5>
                                </div>
                                <h4>Who we are</h4>
                                <p>Our website address is: <a href='https://hirolainfotech.com/'rel="noopener noreferrer" target='_blank'>https://hirolainfotech.com/</a>
                                </p>
                                <h4>About Hirola InfoTech Solutions</h4>
